<div class="search" describe_start="{{$describe_start}}" describe_end="{{$describe_end}}" acreage="{{$acreage}}">
...
<script>
    $(document).on('click','.pagination a', function(e) {
        ...
        var describe_start=$('.search').attr('describe_start');
        var describe_end=$('.search').attr('describe_end');
        var acreage=$('.search').attr('acreage');
        console.log(describe_start,describe_end,acreage,page);
        getPosts(page,describe_end,describe_start,acreage);
    });
    function getPosts(page,describe_end,describe_start,acreage)
    {
        $.ajax({
            type: "GET",
            url: '/SearchDetails',
            data:{describe_start:describe_start,describe_end:describe_end,acreage:acreage,page:page},
            dataType: 'html',
